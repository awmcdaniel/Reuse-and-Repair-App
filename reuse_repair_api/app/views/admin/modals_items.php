      ...
      <div class="modal-body">
        <form>
          ...
          <div class="form-group" id="form_container_category">
            ...
            <select class="form-control" id="input_category" name="input_orgtype" p>
            </select>
          </div>

          <div class="form-group">
            <label for="input_description" >Description</label>
            <input type="text" class="form-control" id="input_description" name="input_description" placeholder="Description">
          </div>
